...
# File Name: VDSS_Haversine_Distances_2012_ZCTA.R

# Purpose: This script calculates Haversine, driving, and transit distances and times
# between ZCTA midpoints and LDSS midpoints using ZCTA, ZIP-FIPS, and VDSS office datasets for 2012.
...
# Load VDSS office data for 2012
vdss_data <- read_excel("Raw Data/VDSS_Zip_Office_Distances/VDSS_Offices_2012.xlsx")
...
# --- Save Results ---
output_path <- "Data Outputs/VDSS_ZCTA_Office_Distances/VDSS_Office_ZCTA_GeoCode_2012_Distances.xlsx"
write.xlsx(merged_data, output_path)

cat("Merged data with distances and times saved to:", output_path, "\n")
